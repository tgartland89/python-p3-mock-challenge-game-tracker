...
# It then iterates over each r element in the _results attribute of the class and for each r element, 
# it appends r.score to player_scores to the player associated with the r element matching the player parameter.
...
# ******************************************************************************************************************************
# this is the sample of what I mirrored to clear the first four fails in the game pytest 
